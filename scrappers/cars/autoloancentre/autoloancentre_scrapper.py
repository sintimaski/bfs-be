...
from scrappers.cars.autoapprove import (
...
class AutoLoanCentreScrapper:
    def __init__(
        ...
        self.token = "T7nBkSvwFG9gWUeTTrFZ"
        self.post_car_url = (
            "https://autoloancentre.ca/wp-json/jwa-cars-listing/v1/cars/{}"
        )
        self.statuses_url = "https://autoloancentre.ca/wp-json/jwa-cars-listing/v1/cars-status-import/"
    ...
    def update_rest(self):
        upload_to = "prod"
        vin_links = {
            "prod": "https://autoloancentre.ca/wp-json/jwa-cars-listing/v1/cars-by-vin/{}",
        }
        vin_link = vin_links[upload_to]
        update_inks = {
            "prod": "https://autoloancentre.ca/wp-json/jwa-cars-listing/v1/cars/{}",
        }
    ...
    def send_rest(self):
        ...
        for car_data in formatted:
            ...
            vin = car_data["vin"]
            resp = scrapper.get(
                "https://autoloancentre.ca/wp-json/jwa-cars-listing/v1/cars-by-vin/{}".format(
                    vin
                )
            )
    ...
    def get_formatted_cars(self) -> List[Dict]:
        ...
        cars = CarProduct.query.filter(
            CarProduct.source.in_(dealerships)
        ).all()
        formatted = []
