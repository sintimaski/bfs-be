...
class LuckyMotorCarsScrapper(BaseCarScrapper):
    def __init__(self, project):
        source = "luckymotorcars"
        source_id = "43382"
    ...
    def get_cars_urls(self):
        base_url = "https://www.luckymotorcars.com"
        listing_url = (
            "https://www.luckymotorcars.com/used-cars/?ppage=50&cpage={}"
        )
        page = 1
        while True:
            scraper = cloudscraper.create_scraper()
