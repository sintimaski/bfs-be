...
class AutoQuestGroupScrapper(BaseCarScrapper):
    def __init__(self, project):
        source = "autoquestgroup"
    ...
    def get_dealership_data(self, car_url: str):
        try:
            ...
            price = "".join(c for c in price if c.isdigit()) or 0
            price = int(price)
            ...
            doors = get_text_by_sibling(details_soup, "Doors:") or None
            if doors:
    ...
    def get_cars_urls(self):
        base_url = "https://www.autoquestgroup.ca"
        listing_url = "https://www.autoquestgroup.ca/used-cars/?ppage=50&cpage={}"
        page = 1
        while True:
            scraper = cloudscraper.create_scraper()
