...
class NewMarketHyundaiScrapper(PlazaLikeScrapper):
    def __init__(self, project):
        source = "newmarkethyundai"
    ...
    def get_dealership_data(self, car_url) -> Dict:
        try:
            ...
            interior_color = self.get_from_next_sibling(soup, " Interior Color ")
    ...
    def get_cars_urls(self):
        base_url = "https://newmarkethyundai.com"
        listing_url = (
            "https://newmarkethyundai.com/View-Inventory/?filters[limit]=10000"
        )
        scraper = cloudscraper.create_scraper()
        ...
        listing_url = (
            "https://newmarkethyundai.com/New-Car-Inventory/?filters[limit]=10000"
        )
        scraper = cloudscraper.create_scraper()
        resp = scraper.get(listing_url, timeout=120)
        soup = BeautifulSoup(markup=resp.text, features="html.parser")
