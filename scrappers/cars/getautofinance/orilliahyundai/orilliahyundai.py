...
class OrilliaHyundaiScrapper(PlazaLikeScrapper):
    def __init__(self, project):
        source = "orilliahyundai"
    ...
    def get_dealership_data(self, car_url) -> Dict:
        try:
            ...
            odometer = soup.select_one('.odometer-box')
    ...
    def get_cars_urls(self):
        base_url = "https://orilliahyundai.com"
        listing_url = (
            "https://orilliahyundai.com/Used-Cars/?filters[limit]=10000"
        )
        scraper = cloudscraper.create_scraper()
        ...
        listing_url = (
            "https://orilliahyundai.com/New-Car-Inventory/?filters[limit]=10000"
        )
        scraper = cloudscraper.create_scraper()
        resp = scraper.get(listing_url, timeout=120)
        soup = BeautifulSoup(markup=resp.text, features="html.parser")
