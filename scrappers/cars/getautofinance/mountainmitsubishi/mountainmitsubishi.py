...
class MountainMitsubishiScrapper(PlazaLikeScrapper):
    def __init__(self, project):
        source = "mountainmitsubishi"
    ...
    def get_cars_urls(self):
        base_url = "https://mountainmitsubishi.ca"
        listing_url = (
            "https://mountainmitsubishi.ca/Used-Inventory/?filters[limit]=10000"
        )
        scraper = cloudscraper.create_scraper()
        ...
        listing_url = (
            "https://mountainmitsubishi.ca/In-Stock/?filters[limit]=10000"
        )
        scraper = cloudscraper.create_scraper()
        resp = scraper.get(listing_url, timeout=120)
        soup = BeautifulSoup(markup=resp.text, features="html.parser")
